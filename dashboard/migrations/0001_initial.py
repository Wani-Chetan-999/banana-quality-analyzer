...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade_a_min', models.FloatField(default=180.0, help_text='Min weight for Grade A (g)')),
                ('grade_b_min', models.FloatField(default=150.0, help_text='Min weight for Grade B (g)')),
                ('grade_c_min', models.FloatField(default=120.0, help_text='Min weight for Grade C (g)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('operator', 'System Operator')], default='operator', max_length=15)),
